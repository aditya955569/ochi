...
function Footer() {
    return (
        <div className='flex gap-10 w-full h-screen bg-zinc-900 p-20'>
            <div className='flex flex-col justify-between h-full w-1/2 font-["Founders_Grotesk_X-Condensed"]'>
            ...
            <div className='w-1/2'>
                <div>
                <h1 className='text-[5vw] uppercase font-["Founders_Grotesk_X-Condensed"] font-semibold leading-none -mb-10'>Presentations
                </h1>
                </div>
                <div className='mt-20'>
                {["Facebook", "Instagram", "Twitter"].map((item, index) =>
                        <a href='#' className=' block uppercase font-semibold '>{item}</a>
                )}
                </div>
            </div>
        </div>
